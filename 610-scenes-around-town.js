...
function crimeContext(me, them) {
  ...
  if (jailed(me)) { const C = crimeById(me.jail.crime); out.push(`You are locked in the cell under Glimmer Hall for ${me.jail.until - W.day} more days, convicted of ${me.jail.label.toLowerCase()}.${C && C.culprit !== me.id ? ' You are innocent and furious about it.' : ''}`); }
