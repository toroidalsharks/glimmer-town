...
sheet.addEventListener('click', (e) => {
  ...
  if (d.craft) { send({ t: 'craft', kind: d.craft, id: d.cid, color: d.color || $('#craftColor')?.value }); return; }
